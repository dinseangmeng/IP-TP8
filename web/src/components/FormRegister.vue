...
const save=(e)=>{
    ...
    if(isValidEmail && isValidPass){
        ...
        bodyFormData.append('firstname',firstName.value)
        bodyFormData.append('lastname',lastName.value)
        ...
        axios({
            ...
            if(res.data.token){
                ...
                errMsg.value=res.data.msg ? res.data.msg:"Invalid form application"
